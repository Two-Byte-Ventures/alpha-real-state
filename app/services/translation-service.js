...
const i18n = rosetta({
  es: {
    ...
    housing: {
      ...
      urlDescription: "URL del folleto PDF de la propiedad",
      urlInvalidFormat: "URL inválida. Debe comenzar con http:// o https://",
      urlMustBePdf: "La URL debe apuntar a un archivo PDF (.pdf)",
      cancel: "Cancelar",
      save: "Guardar",
      next: "Siguiente",
      previous: "Anterior",
  ...
  en: {
    ...
    housing: {
      ...
      urlDescription: "URL of the property PDF brochure",
      urlInvalidFormat: "Invalid URL. Must start with http:// or https://",
      urlMustBePdf: "URL must point to a PDF file (.pdf)",
      cancel: "Cancel",
      save: "Save",
      next: "Next",
      previous: "Previous",
      ...
      step2Title: "Location",
      step3Title: "Images and Brochure",
